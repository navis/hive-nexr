...
interface ThriftHiveMetastoreIf extends \FacebookServiceIf {
  ...
  public function get_partition_names_by_filter($db_name, $tbl_name, $filter, $max_parts);
...
class ThriftHiveMetastoreClient extends \FacebookServiceClient implements \metastore\ThriftHiveMetastoreIf {
  ...
  public function get_partition_names_by_filter($db_name, $tbl_name, $filter, $max_parts)
  {
    $this->send_get_partition_names_by_filter($db_name, $tbl_name, $filter, $max_parts);
    return $this->recv_get_partition_names_by_filter();
  }

  public function send_get_partition_names_by_filter($db_name, $tbl_name, $filter, $max_parts)
  {
    $args = new \metastore\ThriftHiveMetastore_get_partition_names_by_filter_args();
    $args->db_name = $db_name;
    $args->tbl_name = $tbl_name;
    $args->filter = $filter;
    $args->max_parts = $max_parts;
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'get_partition_names_by_filter', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('get_partition_names_by_filter', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_get_partition_names_by_filter()
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\metastore\ThriftHiveMetastore_get_partition_names_by_filter_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \metastore\ThriftHiveMetastore_get_partition_names_by_filter_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
    ...
    throw new \Exception("get_partition_names_by_filter failed: unknown result");
  }
  ...
  public function list_role_members($role_name)
  {
    $this->send_list_role_members($role_name);
    return $this->recv_list_role_members();
  }

  public function send_list_role_members($role_name)
  {
    $args = new \metastore\ThriftHiveMetastore_list_role_members_args();
    $args->role_name = $role_name;
    $bin_accel = ($this->output_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'list_role_members', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('list_role_members', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_list_role_members()
  {
    $bin_accel = ($this->input_ instanceof TProtocol::$TBINARYPROTOCOLACCELERATED) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\metastore\ThriftHiveMetastore_list_role_members_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \metastore\ThriftHiveMetastore_list_role_members_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::MAP) {
            ...
            {
              $key253 = '';
              $val254 = new \metastore\Type();
              $xfer += $input->readString($key253);
              $val254 = new \metastore\Type();
              $xfer += $val254->read($input);
              $this->success[$key253] = $val254;
            }
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::MAP, 0);
      {
        ...
        {
          foreach ($this->success as $kiter255 => $viter256)
          {
            $xfer += $output->writeString($kiter255);
            $xfer += $viter256->write($output);
          }
        }
        $output->writeMapEnd();
      }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem269 = null;
              $elem269 = new \metastore\FieldSchema();
  ...
  public function write($output) {
    ...
    if ($this->tbl_names !== null) {
      ...
      $xfer += $output->writeFieldBegin('tbl_names', TType::LST, 2);
      {
        ...
        {
          foreach ($this->tbl_names as $iter291)
          {
  ...
  public function write($output) {
    ...
    if ($this->new_parts !== null) {
      ...
      $xfer += $output->writeFieldBegin('new_parts', TType::LST, 1);
      {
        ...
        {
          foreach ($this->new_parts as $iter312)
          {
  ...
  public function write($output) {
    ...
    if ($this->part_vals !== null) {
      ...
      $xfer += $output->writeFieldBegin('part_vals', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRING, count($this->part_vals));
        {
          foreach ($this->part_vals as $iter360)
          {
    ...
    if ($this->group_names !== null) {
      ...
      $xfer += $output->writeFieldBegin('group_names', TType::LST, 5);
      {
        ...
        {
          foreach ($this->group_names as $iter361)
          {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem367 = null;
              $elem367 = new \metastore\Partition();
  ...
  public function write($output) {
    ...
    if ($this->group_names !== null) {
      ...
      $xfer += $output->writeFieldBegin('group_names', TType::LST, 5);
      {
        $output->writeListBegin(TType::STRING, count($this->group_names));
        {
          foreach ($this->group_names as $iter375)
          {
...
class ThriftHiveMetastore_get_partition_names_by_filter_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ThriftHiveMetastore_get_partition_names_by_filter_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ThriftHiveMetastore_get_partition_names_by_filter_args');
    if ($this->db_name !== null) {
      $xfer += $output->writeFieldBegin('db_name', TType::STRING, 1);
      $xfer += $output->writeString($this->db_name);
      $xfer += $output->writeFieldEnd();
...
class ThriftHiveMetastore_get_partition_names_by_filter_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'ThriftHiveMetastore_get_partition_names_by_filter_result';
  }
  ...
  public function write($output) {
    ...
    if ($this->part_vals !== null) {
      ...
      $xfer += $output->writeFieldBegin('part_vals', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRING, count($this->part_vals));
        {
          foreach ($this->part_vals as $iter423)
          {
    ...
    if ($this->group_names !== null) {
      ...
      $xfer += $output->writeFieldBegin('group_names', TType::LST, 6);
      {
        $output->writeListBegin(TType::STRING, count($this->group_names));
        {
          foreach ($this->group_names as $iter424)
          {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem465 = null;
              $elem465 = new \metastore\Partition();
      ...
      switch ($fid)
      {
        ...
        case 3:
          if ($ftype == TType::LST) {
            ...
            {
              $elem472 = null;
              $elem472 = new \metastore\Partition();
              $xfer += $elem472->read($input);
              $this->new_parts []= $elem472;
            }
            $xfer += $input->readListEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->new_parts !== null) {
      ...
      $xfer += $output->writeFieldBegin('new_parts', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRUCT, count($this->new_parts));
        {
          foreach ($this->new_parts as $iter473)
          {
  ...
  public function write($output) {
    ...
    if ($this->part_vals !== null) {
      ...
      $xfer += $output->writeFieldBegin('part_vals', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRING, count($this->part_vals));
        {
          foreach ($this->part_vals as $iter480)
          {
  ...
  public function write($output) {
    ...
    if ($this->part_vals !== null) {
      ...
      $xfer += $output->writeFieldBegin('part_vals', TType::LST, 1);
      {
        $output->writeListBegin(TType::STRING, count($this->part_vals));
        {
          foreach ($this->part_vals as $iter487)
          {
        ...
        case 0:
          if ($ftype == TType::MAP) {
            ...
            for ($_i499 = 0; $_i499 < $_size495; ++$_i499)
            {
              $key500 = '';
              $val501 = '';
              $xfer += $input->readString($key500);
              $xfer += $input->readString($val501);
              $this->success[$key500] = $val501;
            }
            $xfer += $input->readMapEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->success !== null) {
      ...
      $xfer += $output->writeFieldBegin('success', TType::MAP, 0);
      {
        ...
        {
          foreach ($this->success as $kiter502 => $viter503)
          {
  ...
  public function write($output) {
    ...
    if ($this->part_vals !== null) {
      ...
      $xfer += $output->writeFieldBegin('part_vals', TType::MAP, 3);
      {
        ...
        {
          foreach ($this->part_vals as $kiter511 => $viter512)
          {
        ...
        case 3:
          if ($ftype == TType::MAP) {
            ...
            for ($_i517 = 0; $_i517 < $_size513; ++$_i517)
            {
              ...
              $xfer += $input->readString($val519);
              $this->part_vals[$key518] = $val519;
            }
            $xfer += $input->readMapEnd();
          } else {
            $xfer += $input->skip($ftype);
  ...
  public function write($output) {
    ...
    if ($this->part_vals !== null) {
      ...
      $xfer += $output->writeFieldBegin('part_vals', TType::MAP, 3);
      {
        $output->writeMapBegin(TType::STRING, TType::STRING, count($this->part_vals));
        {
          foreach ($this->part_vals as $kiter520 => $viter521)
          {
            $xfer += $output->writeString($kiter520);
            $xfer += $output->writeString($viter521);
          }
        }
        $output->writeMapEnd();
      }
...
class ThriftHiveMetastore_list_role_members_args {
  ...
  public function getName() {
    return 'ThriftHiveMetastore_list_role_members_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ThriftHiveMetastore_list_role_members_args');
    if ($this->role_name !== null) {
      $xfer += $output->writeFieldBegin('role_name', TType::STRING, 1);
      $xfer += $output->writeString($this->role_name);
      $xfer += $output->writeFieldEnd();
...
class ThriftHiveMetastore_list_role_members_result {
  ...
  public function getName() {
    return 'ThriftHiveMetastore_list_role_members_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('ThriftHiveMetastore_list_role_members_result');
    if ($this->success !== null) {
      if (!is_array($this->success)) {
        throw new TProtocolException('Bad type in structure.', TProtocolException::INVALID_DATA);
      }
  ...
  public function write($output) {
    ...
    if ($this->group_names !== null) {
      ...
      $xfer += $output->writeFieldBegin('group_names', TType::LST, 3);
      {
        $output->writeListBegin(TType::STRING, count($this->group_names));
        {
          foreach ($this->group_names as $iter563)
          {
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem576 = null;
              $elem576 = new \metastore\HiveObjectPrivilege();
  ...
  public function write($output) {
    ...
    if ($this->group_names !== null) {
      ...
      $xfer += $output->writeFieldBegin('group_names', TType::LST, 2);
      {
        $output->writeListBegin(TType::STRING, count($this->group_names));
        {
          foreach ($this->group_names as $iter584)
          {
