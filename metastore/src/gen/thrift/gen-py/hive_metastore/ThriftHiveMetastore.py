...
class Iface(fb303.FacebookService.Iface):
  ...
  def drop_partitions(self, db_name, tbl_name, part_vals, deleteData):
    """
    Parameters:
     - db_name
     - tbl_name
  ...
  def drop_partitions_with_environment_context(self, db_name, tbl_name, part_vals, deleteData, environment_context):
    """
    Parameters:
     - db_name
     - tbl_name
...
class Client(fb303.FacebookService.Client, Iface):
  ...
  def drop_partitions(self, db_name, tbl_name, part_vals, deleteData):
    ...
    Parameters:
     ...
     - deleteData
    """
    self.send_drop_partitions(db_name, tbl_name, part_vals, deleteData)
    return self.recv_drop_partitions()

  def send_drop_partitions(self, db_name, tbl_name, part_vals, deleteData):
    self._oprot.writeMessageBegin('drop_partitions', TMessageType.CALL, self._seqid)
    args = drop_partitions_args()
    args.db_name = db_name
    args.tbl_name = tbl_name
    args.part_vals = part_vals
    args.deleteData = deleteData
  ...
  def recv_drop_partitions(self, ):
    ...
    if result.o2 is not None:
      raise result.o2
    raise TApplicationException(TApplicationException.MISSING_RESULT, "drop_partitions failed: unknown result");
  ...
  def drop_partitions_with_environment_context(self, db_name, tbl_name, part_vals, deleteData, environment_context):
    ...
    Parameters:
     ...
     - environment_context
    """
    self.send_drop_partitions_with_environment_context(db_name, tbl_name, part_vals, deleteData, environment_context)
    return self.recv_drop_partitions_with_environment_context()

  def send_drop_partitions_with_environment_context(self, db_name, tbl_name, part_vals, deleteData, environment_context):
    self._oprot.writeMessageBegin('drop_partitions_with_environment_context', TMessageType.CALL, self._seqid)
    args = drop_partitions_with_environment_context_args()
    args.db_name = db_name
    args.tbl_name = tbl_name
    args.part_vals = part_vals
    args.deleteData = deleteData
  ...
  def recv_drop_partitions_with_environment_context(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
    ...
    if result.o2 is not None:
      raise result.o2
    raise TApplicationException(TApplicationException.MISSING_RESULT, "drop_partitions_with_environment_context failed: unknown result");
...
class Processor(fb303.FacebookService.Processor, Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["drop_partitions"] = Processor.process_drop_partitions
    self._processMap["drop_partitions_with_environment_context"] = Processor.process_drop_partitions_with_environment_context
  ...
  def process_drop_partitions(self, seqid, iprot, oprot):
    args = drop_partitions_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = drop_partitions_result()
    try:
      result.success = self._handler.drop_partitions(args.db_name, args.tbl_name, args.part_vals, args.deleteData)
    except NoSuchObjectException as o1:
      result.o1 = o1
    except MetaException as o2:
      result.o2 = o2
    oprot.writeMessageBegin("drop_partitions", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()

  def process_drop_partitions_with_environment_context(self, seqid, iprot, oprot):
    args = drop_partitions_with_environment_context_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = drop_partitions_with_environment_context_result()
    try:
      result.success = self._handler.drop_partitions_with_environment_context(args.db_name, args.tbl_name, args.part_vals, args.deleteData, args.environment_context)
    except NoSuchObjectException as o1:
      result.o1 = o1
    except MetaException as o2:
      result.o2 = o2
    oprot.writeMessageBegin("drop_partitions_with_environment_context", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class drop_partitions_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('drop_partitions_args')
    if self.db_name is not None:
      oprot.writeFieldBegin('db_name', TType.STRING, 1)
      oprot.writeString(self.db_name)
      oprot.writeFieldEnd()
...
class drop_partitions_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('drop_partitions_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class drop_partitions_with_environment_context_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('drop_partitions_with_environment_context_args')
    if self.db_name is not None:
      oprot.writeFieldBegin('db_name', TType.STRING, 1)
      oprot.writeString(self.db_name)
      oprot.writeFieldEnd()
...
class drop_partitions_with_environment_context_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('drop_partitions_with_environment_context_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class exchange_partition_args:
      ...
      if fid == 1:
        if ftype == TType.MAP:
          ...
          for _i594 in xrange(_size590):
            ...
            self.partitionSpecs[_key595] = _val596
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.partitionSpecs is not None:
      ...
      for kiter597,viter598 in self.partitionSpecs.items():
        oprot.writeString(kiter597)
        oprot.writeString(viter598)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i609 in xrange(_size605):
            ...
            self.group_names.append(_elem610)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i624 in xrange(_size620):
            ...
            self.group_names.append(_elem625)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class get_partitions_ps_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i672 in xrange(_size668):
            ...
            self.group_names.append(_elem673)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter675 in self.group_names:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i729 in xrange(_size725):
            _elem730 = Partition()
            _elem730.read(iprot)
            self.new_parts.append(_elem730)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class markPartitionForEvent_args:
  ...
  def read(self, iprot):
    ...
    while True:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          self.part_vals = {}
          (_ktype763, _vtype764, _size762 ) = iprot.readMapBegin() 
          for _i766 in xrange(_size762):
            _key767 = iprot.readString();
            _val768 = iprot.readString();
            self.part_vals[_key767] = _val768
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      ...
      for kiter769,viter770 in self.part_vals.items():
        oprot.writeString(kiter769)
        oprot.writeString(viter770)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i775 in xrange(_size771):
            ...
            self.part_vals[_key776] = _val777
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter778,viter779 in self.part_vals.items():
