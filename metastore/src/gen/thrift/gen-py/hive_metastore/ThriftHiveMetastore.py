...
class Iface(fb303.FacebookService.Iface):
  ...
  def get_partition_names_by_filter(self, db_name, tbl_name, filter, max_parts):
    """
    Parameters:
     - db_name
     - tbl_name
  ...
  def list_role_members(self, role_name):
    """
    Parameters:
     - role_name
    """
...
class Client(fb303.FacebookService.Client, Iface):
  ...
  def get_partition_names_by_filter(self, db_name, tbl_name, filter, max_parts):
    ...
    Parameters:
     ...
     - max_parts
    """
    self.send_get_partition_names_by_filter(db_name, tbl_name, filter, max_parts)
    return self.recv_get_partition_names_by_filter()

  def send_get_partition_names_by_filter(self, db_name, tbl_name, filter, max_parts):
    self._oprot.writeMessageBegin('get_partition_names_by_filter', TMessageType.CALL, self._seqid)
    args = get_partition_names_by_filter_args()
    args.db_name = db_name
    args.tbl_name = tbl_name
    args.filter = filter
    args.max_parts = max_parts
  ...
  def recv_get_partition_names_by_filter(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = get_partition_names_by_filter_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
    if result.o2 is not None:
      raise result.o2
    raise TApplicationException(TApplicationException.MISSING_RESULT, "get_partition_names_by_filter failed: unknown result");
  ...
  def list_role_members(self, role_name):
    ...
    Parameters:
     - role_name
    """
    self.send_list_role_members(role_name)
    return self.recv_list_role_members()

  def send_list_role_members(self, role_name):
    self._oprot.writeMessageBegin('list_role_members', TMessageType.CALL, self._seqid)
    args = list_role_members_args()
    args.role_name = role_name
    args.write(self._oprot)
    self._oprot.writeMessageEnd()
    self._oprot.trans.flush()

  def recv_list_role_members(self, ):
    (fname, mtype, rseqid) = self._iprot.readMessageBegin()
    if mtype == TMessageType.EXCEPTION:
      x = TApplicationException()
      x.read(self._iprot)
      self._iprot.readMessageEnd()
      raise x
    result = list_role_members_result()
    result.read(self._iprot)
    self._iprot.readMessageEnd()
    if result.success is not None:
      return result.success
...
class Processor(fb303.FacebookService.Processor, Iface, TProcessor):
  def __init__(self, handler):
    ...
    self._processMap["get_partition_names_by_filter"] = Processor.process_get_partition_names_by_filter
    ...
    self._processMap["list_role_members"] = Processor.process_list_role_members
  ...
  def process_get_partition_names_by_filter(self, seqid, iprot, oprot):
    args = get_partition_names_by_filter_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = get_partition_names_by_filter_result()
    try:
      result.success = self._handler.get_partition_names_by_filter(args.db_name, args.tbl_name, args.filter, args.max_parts)
    except MetaException as o2:
      result.o2 = o2
    oprot.writeMessageBegin("get_partition_names_by_filter", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
  ...
  def process_list_role_members(self, seqid, iprot, oprot):
    args = list_role_members_args()
    args.read(iprot)
    iprot.readMessageEnd()
    result = list_role_members_result()
    try:
      result.success = self._handler.list_role_members(args.role_name)
    except MetaException as o1:
      result.o1 = o1
    oprot.writeMessageBegin("list_role_members", TMessageType.REPLY, seqid)
    result.write(oprot)
    oprot.writeMessageEnd()
    oprot.trans.flush()
...
class get_partition_names_by_filter_args:
  """
  Attributes:
   - db_name
   - tbl_name
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('get_partition_names_by_filter_args')
    if self.db_name is not None:
      oprot.writeFieldBegin('db_name', TType.STRING, 1)
      oprot.writeString(self.db_name)
      oprot.writeFieldEnd()
...
class get_partition_names_by_filter_result:
  """
  Attributes:
   - success
   - o2
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('get_partition_names_by_filter_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRING, len(self.success))
...
class get_partitions_ps_with_auth_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i415 in xrange(_size411):
            ...
            self.part_vals.append(_elem416)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
        ...
        if ftype == TType.LIST:
          ...
          for _i421 in xrange(_size417):
            ...
            self.group_names.append(_elem422)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter424 in self.group_names:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i471 in xrange(_size467):
            _elem472 = Partition()
            _elem472.read(iprot)
            self.new_parts.append(_elem472)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i485 in xrange(_size481):
            ...
            self.part_vals.append(_elem486)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 2:
  ...
  def write(self, oprot):
    ...
    if self.success is not None:
      ...
      for kiter502,viter503 in self.success.items():
        oprot.writeString(kiter502)
        oprot.writeString(viter503)
      oprot.writeMapEnd()
      oprot.writeFieldEnd()
    if self.o1 is not None:
      oprot.writeFieldBegin('o1', TType.STRUCT, 1)
...
class markPartitionForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i508 in xrange(_size504):
            ...
            self.part_vals[_key509] = _val510
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      ...
      for kiter511,viter512 in self.part_vals.items():
...
class isPartitionMarkedForEvent_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i517 in xrange(_size513):
            ...
            self.part_vals[_key518] = _val519
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.part_vals is not None:
      oprot.writeFieldBegin('part_vals', TType.MAP, 3)
      oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.part_vals))
      for kiter520,viter521 in self.part_vals.items():
        oprot.writeString(kiter520)
...
class list_role_members_args:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('list_role_members_args')
    if self.role_name is not None:
      oprot.writeFieldBegin('role_name', TType.STRING, 1)
      oprot.writeString(self.role_name)
      oprot.writeFieldEnd()
...
class list_role_members_result:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('list_role_members_result')
    if self.success is not None:
      oprot.writeFieldBegin('success', TType.LIST, 0)
      oprot.writeListBegin(TType.STRUCT, len(self.success))
...
class get_privilege_set_args:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i561 in xrange(_size557):
            ...
            self.group_names.append(_elem562)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 4:
  ...
  def write(self, oprot):
    ...
    if self.group_names is not None:
      ...
      oprot.writeListBegin(TType.STRING, len(self.group_names))
      for iter563 in self.group_names:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i582 in xrange(_size578):
            ...
            self.group_names.append(_elem583)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
