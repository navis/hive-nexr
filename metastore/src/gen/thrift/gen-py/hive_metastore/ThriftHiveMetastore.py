...
class Client(fb303.FacebookService.Client, Iface):
  ...
  def recv_drop_table(self, ):
    ...
    if result.o3 is not None:
      raise result.o3
    raise TApplicationException(TApplicationException.MISSING_RESULT, "drop_table failed: unknown result");
  ...
  def drop_table_with_environment_context(self, dbname, name, deleteData, environment_context):
    ...
    return self.recv_drop_table_with_environment_context()
  ...
  def recv_drop_table_with_environment_context(self, ):
    ...
    if result.o3 is not None:
      raise result.o3
    raise TApplicationException(TApplicationException.MISSING_RESULT, "drop_table_with_environment_context failed: unknown result");
...
class Processor(fb303.FacebookService.Processor, Iface, TProcessor):
  ...
  def process_drop_table(self, seqid, iprot, oprot):
    ...
    result = drop_table_result()
    try:
      result.success = self._handler.drop_table(args.dbname, args.name, args.deleteData)
    except NoSuchObjectException as o1:
      result.o1 = o1
    except MetaException as o3:
      result.o3 = o3
  ...
  def process_drop_table_with_environment_context(self, seqid, iprot, oprot):
    ...
    result = drop_table_with_environment_context_result()
    try:
      result.success = self._handler.drop_table_with_environment_context(args.dbname, args.name, args.deleteData, args.environment_context)
    except NoSuchObjectException as o1:
      result.o1 = o1
    except MetaException as o3:
      result.o3 = o3
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i524 in xrange(_size520):
            ...
            self.tbl_names.append(_elem525)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
