      ...
      InvalidInputException
   {
    ...
    public List<HiveObjectPrivilege> list_privileges(String principalName,
      ...
      if (principalName == null) {
        return listPrivileges(null, null, hiveObject);
      }
      return listPrivileges(principalName, principalType, hiveObject);
    }

    private List<HiveObjectPrivilege> listPrivileges(String principalName,
