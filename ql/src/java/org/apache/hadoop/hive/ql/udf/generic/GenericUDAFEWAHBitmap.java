  ...
  public static class GenericUDAFEWAHBitmapEvaluator extends GenericUDAFEvaluator {
    ...
    public ObjectInspector init(Mode m, ObjectInspector[] parameters)
      ...
      if (m == Mode.PARTIAL1 || m == Mode.COMPLETE) {
        ...
        internalMergeOI = EWAHUtils.getPrimitiveListOI(parameters[0], "ewah_bitmap");
      }
    ...
    public Object terminate(AggregationBuffer agg) throws HiveException {
      BitmapAgg myagg = (BitmapAgg) agg;
      return EWAHUtils.bitmapToWordArray(myagg.bitmap, bitmapOut);
    }
    ...
    public void merge(AggregationBuffer agg, Object partial)
        throws HiveException {
      BitmapAgg myagg = (BitmapAgg) agg;
      myagg.bitmap = myagg.bitmap.or(
          EWAHUtils.wordArrayToBitmap(bitmap1, bitmapIn, internalMergeOI, partial));
    }
