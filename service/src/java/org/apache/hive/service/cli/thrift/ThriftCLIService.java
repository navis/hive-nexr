...
public class ThriftCLIService extends AbstractService implements TCLIService.Iface, Runnable {
  ...
  public TOpenSessionResp OpenSession(TOpenSessionReq req) throws TException {
    ...
    try {
      ...
      SessionHandle sessionHandle = sqlService
  ...
  public TGetInfoResp GetInfo(TGetInfoReq req) throws TException {
    ...
    try {
      GetInfoValue getInfoValue =
          sqlService.getInfo(new SessionHandle(req.getSessionHandle()),
  ...
  public TExecuteStatementResp ExecuteStatement(TExecuteStatementReq req) throws TException {
    ...
    try {
      ...
      OperationHandle operationHandle =
          sqlService.executeStatement(sessionHandle, statement, confOverlay);
  ...
  public TGetTypeInfoResp GetTypeInfo(TGetTypeInfoReq req) throws TException {
    ...
    try {
      OperationHandle operationHandle = sqlService.getTypeInfo(new SessionHandle(req.getSessionHandle()));
      resp.setOperationHandle(operationHandle.toTOperationHandle());
      resp.setStatus(OK_STATUS);
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public TGetCatalogsResp GetCatalogs(TGetCatalogsReq req) throws TException {
    ...
    try {
      OperationHandle opHandle = sqlService.getCatalogs(new SessionHandle(req.getSessionHandle()));
  ...
  public TGetSchemasResp GetSchemas(TGetSchemasReq req) throws TException {
    ...
    try {
      OperationHandle opHandle = sqlService.getSchemas(
  ...
  public TGetTablesResp GetTables(TGetTablesReq req) throws TException {
    ...
    try {
      OperationHandle opHandle = sqlService
  ...
  public TGetTableTypesResp GetTableTypes(TGetTableTypesReq req) throws TException {
    ...
    try {
      OperationHandle opHandle = sqlService.getTableTypes(new SessionHandle(req.getSessionHandle()));
      resp.setOperationHandle(opHandle.toTOperationHandle());
      resp.setStatus(OK_STATUS);
    } catch (Exception e) {
      e.printStackTrace();
  ...
  public TGetColumnsResp GetColumns(TGetColumnsReq req) throws TException {
    ...
    try {
      OperationHandle opHandle = sqlService.getColumns(
  ...
  public TGetFunctionsResp GetFunctions(TGetFunctionsReq req) throws TException {
    ...
    try {
      OperationHandle opHandle = sqlService.getFunctions(
  ...
  public TGetOperationStatusResp GetOperationStatus(TGetOperationStatusReq req) throws TException {
    ...
    try {
      OperationState operationState = sqlService.getOperationStatus(new OperationHandle(req.getOperationHandle()));
  ...
  public TCancelOperationResp CancelOperation(TCancelOperationReq req) throws TException {
    ...
    try {
      sqlService.cancelOperation(new OperationHandle(req.getOperationHandle()));
      resp.setStatus(OK_STATUS);
    } catch (Exception e) {
      e.printStackTrace();
      resp.setStatus(HiveSQLException.toTStatus(e));
  ...
  public TCloseOperationResp CloseOperation(TCloseOperationReq req) throws TException {
    ...
    try {
      sqlService.closeOperation(new OperationHandle(req.getOperationHandle()));
      resp.setStatus(OK_STATUS);
    } catch (Exception e) {
      e.printStackTrace();
      resp.setStatus(HiveSQLException.toTStatus(e));
  ...
  public TGetResultSetMetadataResp GetResultSetMetadata(TGetResultSetMetadataReq req)
    ...
    try {
      TableSchema schema = sqlService.getResultSetMetadata(new OperationHandle(req.getOperationHandle()));
  ...
  public TFetchResultsResp FetchResults(TFetchResultsReq req) throws TException {
    ...
    try {
      RowSet rowSet = sqlService.fetchResults(
