...
import org.apache.hive.service.cli.thrift.TType;
...
public enum Type {
  ...
  Type(String name, int javaSQLType, TType tType, boolean isComplex, boolean isCollection) {
    this.name = name;
  ...
  Type(String name, int javaSqlType, TType tType) {
  ...
  public static Type getType(TType tType) {
    ...
    // TODO: This should return UNDEFINED_TYPE
    return Type.USER_DEFINED_TYPE;
  }
  ...
  public Integer getNumPrecRadix() {
    ...
    case DOUBLE_TYPE:
      return 2;
    default:
      // anything else (inluding boolean and string) is null
      return null;
    }
  }
