      ...
      if (struct.tableTypes != null) {
        if (struct.isSetTableTypes()) {
          oprot.writeFieldBegin(TABLE_TYPES_FIELD_DESC);
          {
            ...
            for (String _iter165 : struct.tableTypes)
            {
      ...
      if (struct.isSetTableTypes()) {
        {
          ...
          for (String _iter166 : struct.tableTypes)
          {
