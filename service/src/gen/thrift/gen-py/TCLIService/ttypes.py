...
class TBinaryValue:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TBinaryValue')
    if self.value is not None:
      oprot.writeFieldBegin('value', TType.STRING, 1)
      oprot.writeString(self.value)
      oprot.writeFieldEnd()
...
class TColumn:
  ...
  thrift_spec = (
    ...
    (8, TType.LIST, 'binaryColumn', (TType.STRUCT,(TBinaryValue, TBinaryValue.thrift_spec)), None, ), # 8
  )

  def __init__(self, boolColumn=None, byteColumn=None, i16Column=None, i32Column=None, i64Column=None, doubleColumn=None, stringColumn=None, binaryColumn=None,):
    ...
    self.binaryColumn = binaryColumn
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i78 in xrange(_size74):
            _elem79 = TBinaryValue()
            _elem79.read(iprot)
            self.binaryColumn.append(_elem79)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.doubleColumn is not None:
      ...
      for iter85 in self.doubleColumn:
        iter85.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.stringColumn is not None:
      ...
      for iter86 in self.stringColumn:
        iter86.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    if self.binaryColumn is not None:
      oprot.writeFieldBegin('binaryColumn', TType.LIST, 8)
      oprot.writeListBegin(TType.STRUCT, len(self.binaryColumn))
      for iter87 in self.binaryColumn:
        iter87.write(oprot)
      oprot.writeListEnd()
      oprot.writeFieldEnd()
    oprot.writeFieldStop()
...
class TColumnValue:
  ...
  thrift_spec = (
    ...
    (8, TType.STRUCT, 'binaryVal', (TBinaryValue, TBinaryValue.thrift_spec), None, ), # 8
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i92 in xrange(_size88):
            _elem93 = TColumnValue()
            _elem93.read(iprot)
            self.colVals.append(_elem93)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class TStatus:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i113 in xrange(_size109):
            ...
            self.infoMessages.append(_elem114)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      elif fid == 3:
  ...
  def write(self, oprot):
    ...
    if self.infoMessages is not None:
      ...
      for iter115 in self.infoMessages:
...
class TOpenSessionReq:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i120 in xrange(_size116):
            ...
            self.configuration[_key121] = _val122
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.configuration is not None:
      ...
      for kiter123,viter124 in self.configuration.items():
...
class TExecuteStatementReq:
      ...
      if fid == 1:
        ...
        if ftype == TType.MAP:
          ...
          for _i138 in xrange(_size134):
            ...
            self.confOverlay[_key139] = _val140
          iprot.readMapEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.confOverlay is not None:
      ...
      for kiter141,viter142 in self.confOverlay.items():
...
class TGetTablesReq:
      ...
      if fid == 1:
        ...
        if ftype == TType.LIST:
          ...
          for _i147 in xrange(_size143):
            ...
            self.tableTypes.append(_elem148)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
  ...
  def write(self, oprot):
    ...
    if self.tableTypes is not None:
      ...
      for iter149 in self.tableTypes:
...
class TCompileRes:
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TCompileRes')
    if self.status is not None:
      oprot.writeFieldBegin('status', TType.STRUCT, 1)
      self.status.write(oprot)
      oprot.writeFieldEnd()
...
class TRunReq:
  ...
  def __init__(self, sessionHandle=None, operationHandle=None,):
    self.sessionHandle = sessionHandle
    self.operationHandle = operationHandle
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TRunReq')
    if self.sessionHandle is not None:
      oprot.writeFieldBegin('sessionHandle', TType.STRUCT, 1)
      self.sessionHandle.write(oprot)
      oprot.writeFieldEnd()
...
class TSessionInfo:
  ...
  def __init__(self, sessionHandle=None, startTime=None,):
    self.sessionHandle = sessionHandle
...
class TSessionsRes:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'sessions', (TType.STRUCT,(TSessionInfo, TSessionInfo.thrift_spec)), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i154 in xrange(_size150):
            _elem155 = TSessionInfo()
            _elem155.read(iprot)
            self.sessions.append(_elem155)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
...
class TOperationInfo:
  ...
  def __init__(self, status=None, operationHandle=None, query=None, startTime=None,):
    self.status = status
    self.operationHandle = operationHandle
    self.query = query
    self.startTime = startTime
  ...
  def write(self, oprot):
    if oprot.__class__ == TBinaryProtocol.TBinaryProtocolAccelerated and self.thrift_spec is not None and fastbinary is not None:
      oprot.trans.write(fastbinary.encode_binary(self, (self.__class__, self.thrift_spec)))
      return
    oprot.writeStructBegin('TOperationInfo')
    if self.status is not None:
...
class TOperationsRes:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.LIST, 'operations', (TType.STRUCT,(TOperationInfo, TOperationInfo.thrift_spec)), None, ), # 1
  )
      ...
      if fid == 1:
        if ftype == TType.LIST:
          ...
          for _i161 in xrange(_size157):
            _elem162 = TOperationInfo()
            _elem162.read(iprot)
            self.operations.append(_elem162)
          iprot.readListEnd()
        else:
          iprot.skip(ftype)
      else:
