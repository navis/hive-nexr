...
module TType
  ...
  VALUE_MAP = {0 => "VOID_TYPE", 1 => "BOOLEAN_TYPE", 2 => "TINYINT_TYPE", 3 => "SMALLINT_TYPE", 4 => "INT_TYPE", 5 => "BIGINT_TYPE", 6 => "FLOAT_TYPE", 7 => "DOUBLE_TYPE", 8 => "STRING_TYPE", 9 => "TIMESTAMP_TYPE", 10 => "BINARY_TYPE", 11 => "ARRAY_TYPE", 12 => "MAP_TYPE", 13 => "STRUCT_TYPE", 14 => "UNION_TYPE", 15 => "USER_DEFINED_TYPE"}
  VALID_VALUES = Set.new([VOID_TYPE, BOOLEAN_TYPE, TINYINT_TYPE, SMALLINT_TYPE, INT_TYPE, BIGINT_TYPE, FLOAT_TYPE, DOUBLE_TYPE, STRING_TYPE, TIMESTAMP_TYPE, BINARY_TYPE, ARRAY_TYPE, MAP_TYPE, STRUCT_TYPE, UNION_TYPE, USER_DEFINED_TYPE]).freeze
end
